...
function gotResult(error, results){
    if (error){
        ...
        if (results[0].label == "t"){
            ...
            document.getElementById("emoji1").innerHTML = "YO YO SO COOL!!!!";
        }
        if (results[0].label == "v"){
            document.getElementById("emoji").innerHTML = "&#9996;";
            document.getElementById("emoji1").innerHTML = "WIN WIN VICTORY!!!!";
        }
        if (results[0].label == "h"){
            document.getElementById("emoji").innerHTML = "&#128400;";
            document.getElementById("emoji1").innerHTML = "HI!!!!";
        }
    }
}